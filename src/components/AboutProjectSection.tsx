  ...
  return <section id="om" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">Prosjektet er utviklet i sammarbeid mellom to familier fra Høn. Wessel/Nore-familien som i 2011 fikk Tandberg Eiendom inn som medeier i selskapet. Sammen ønsket de å bygge noe de kunne være stolte av.</p>
        </div>
